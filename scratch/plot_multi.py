...
cwnd0 = pd.read_csv("2min_best_tcp_llm_multi_sender_results/cwnd_0.dat", delim_whitespace=True, header=None, names=["Time", "CWND0"])
cwnd1 = pd.read_csv("2min_best_tcp_llm_multi_sender_results/cwnd_1.dat", delim_whitespace=True, header=None, names=["Time", "CWND1"])
cwnd2 = pd.read_csv("2min_best_tcp_llm_multi_sender_results/cwnd_2.dat", delim_whitespace=True, header=None, names=["Time", "CWND2"])
queue_size = pd.read_csv("2min_best_tcp_llm_multi_sender_results/queueSize.dat", delim_whitespace=True, header=None, names=["Time", "QueueSize"])
rtt0 = pd.read_csv("2min_best_tcp_llm_multi_sender_results/rtt_0.dat", delim_whitespace=True, header=None, names=["Time", "RTT0"])
rtt1 = pd.read_csv("2min_best_tcp_llm_multi_sender_results/rtt_1.dat", delim_whitespace=True, header=None, names=["Time", "RTT1"])
rtt2 = pd.read_csv("2min_best_tcp_llm_multi_sender_results/rtt_2.dat", delim_whitespace=True, header=None, names=["Time", "RTT2"])
throughput = pd.read_csv("2min_best_tcp_llm_multi_sender_results/throughput.dat", delim_whitespace=True, header=None, names=["Time", "Throughput"])
