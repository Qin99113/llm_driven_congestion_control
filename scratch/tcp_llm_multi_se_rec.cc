...
//                                                 
// [sender0]---100Mbps--- [Router1]---100Mbps---[Router2]      ---100Mbps---[receiver0]
// [sender1]---100Mbps---                                     ---100Mbps---[receiver1]
// [sender2]---100Mbps---                                     ---100Mbps---[receiver2]
...
int main(int argc, char* argv[])
{
    ...
    {
        receiverEdges[i] = edgeLink.Install(routers.Get(1), receivers.Get(i));
    }
