...
# Plot CWND
plot_metric("CWND", cwnd_method, cwnd_baseline, "CWND", "plot_comparison/multi_sender/cwnd_comparison.png")

# Plot Queue Size
plot_metric("QueueSize", queue_size_method, queue_size_baseline, "Queue Size", "plot_comparison/multi_sender/queue_comparison.png")
