...
cwnd = pd.read_csv("newreno/one_to_one/cwnd.dat", delim_whitespace=True, header=None, names=["Time", "CWND"])
queue_size = pd.read_csv("newreno/one_to_one/queueSize.dat", delim_whitespace=True, header=None, names=["Time", "QueueSize"])
rtt = pd.read_csv("newreno/one_to_one/rtt.dat", delim_whitespace=True, header=None, names=["Time", "RTT"])
throughput = pd.read_csv("newreno/one_to_one/throughput.dat", delim_whitespace=True, header=None, names=["Time", "Throughput"])
